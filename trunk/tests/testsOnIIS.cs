...
// lol super-polluted namespace, since we reference both autogenerated stuff via WPF and the assembly itself
using bladeSpec = bladeDirector.bladeSpec;
using resultCodeAndBIOSConfig = tests.networkService.resultCodeAndBIOSConfig;
