...
reg add \"HKLM\\Software\\Microsoft\\Windows\\CurrentVersion\\WindowsUpdate\" /v TargetGroup /t REG_SZ /d "blades" /f
reg add \"HKLM\\Software\\Microsoft\\Windows\\CurrentVersion\\WindowsUpdate\" /v TargetGroupEnabled /t REG_DWORD /d 1 /f
net stop wuauserv
net start wuauserv
